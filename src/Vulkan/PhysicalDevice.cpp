...
PhysicalDeviceQueueFamilyIndexInfo generateDeviceQueueFamiliesInfo(VkPhysicalDevice device, VkSurfaceKHR surface) {
 ...
 * exception.
 */
PhysicalDevice::PhysicalDevice(const VkInstance &inst, const VkSurfaceKHR &surface, const Log::ILogger &logger)
