...
debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
  ...
  case VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT:
    logger->logError("validation layer: " +
                     std::string(pCallbackData->pMessage));
    break;
  case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT:
    logger->logWarning("validation layer: " +
                       std::string(pCallbackData->pMessage));
    break;
  default:
    logger->logInfo("validation layer: " +
                    std::string(pCallbackData->pMessage));
  }
...
Debug::Debug(bool enableValidationLayers, const Instance &instance,
  ...
  if (createDebugUtilsMessengerExt(instance.getInstancePtr(), &createInfo,
...
Debug::~Debug() {
  destroyDebugUtilsMessengerExt(referenceInstance.getInstancePtr(),
                                debugMessenger, nullptr);
}

VkDebugUtilsMessengerCreateInfoEXT
Debug::populateDebugMessengerCreateInfo(const Log::ILogger &logger) {
